...
export default async function PodcastsPage() {
  ...
  return (
    <div className="pb-12">
      ...
      {sanityPodcasts.length === 0 ? (
        <EmptyState
          icon={Headphones}
          title="Coming Soon"
          description="We're working on bringing you insightful conversations with the people shaping East Africa's tech ecosystem. Stay tuned for our first episodes."

...
export default function SignInPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simulate API delay
    setTimeout(() => {
      // In a real app, this would set auth context/cookies
      router.push('/');
    }, 1500);
  };
  ...
  const handleForgotSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Show success message for reset link
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-gray-100">
          ...
          <form className="space-y-6" onSubmit={handleForgotSubmit}>
              ...
              <button
              type="submit"
              className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#000137] hover:bg-[#2f3192] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#2f3192] transition-colors">
          ...
          <motion.div
            ...
            className="absolute inset-0 bg-white/90 backdrop-blur-sm rounded-lg flex flex-col items-center justify-center z-10">
              ...
              className="flex flex-col items-center">
                ...
                <h3 className="text-2xl font-serif font-bold text-[#000137]">
                  Welcome!
                </h3>

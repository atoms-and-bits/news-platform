 ...
 * Client component: Handles category filtering and animations
 * Displays all articles with interactive category filter
 */
'use client';
...
// ─── Component ───────────────────────────────────────────────
export function StoriesContent({ articles }: StoriesContentProps) {
            ...
            <button
              ...
              className={`px-5 py-2 rounded-full text-sm font-bold whitespace-nowrap transition-all ${
                activeCategory === cat
                  ...
                  : 'bg-white text-[#000137] border border-gray-200 hover:bg-gray-50'
              }`}
            >
              {cat}
            </button>

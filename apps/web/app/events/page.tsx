...
const mockUser: { name: string; email: string; plan: 'free' | 'premium' } | null = null; // Set to null to simulate logged out state
          ...
          {events.map((event) => {
            ...
            return (
              <div
                ...
                <div
                  className={`h-2 ${event.premium ? 'bg-amber-400' : 'bg-[#2f3192]'}`} />
